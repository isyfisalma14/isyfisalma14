...
|-----------|----------------|
| QA & Testing | Postman, Selenium, Test Cases, Bug Report |
| Design | Figma, Canva, Wireframing, Usability Testing |
| Programming | Java, PHP, HTML, CSS |
| Data Tools | Excel, e-SPT |
| Others | Git, GitHub, Team Collaboration |
